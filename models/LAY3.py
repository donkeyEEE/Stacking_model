...
class ensemble_models:
    ...
    def Lay1_models_train(self, Args, mode='regression', save=False):
        ...
        if AFP:
            ...
            print(mode)
            model_AFP = AttentiveFPModel(mode=mode, n_tasks=1,
        ...
        if RF:
            ...
            if mode == 'classification':
                model_RF = dc.models.SklearnModel(RandomForestClassifier(n_estimators=181, min_samples_split=14),
                                                  model_dir='E:\学习\文献库\pythonProject\models/tmp/RF')
        ...
        if SVR:
            ...
            if mode == 'classification':
                model_SVR = dc.models.SklearnModel(svm.SVC(C=1),
                                               model_dir='E:\学习\文献库\pythonProject\models/tmp/SVR')
